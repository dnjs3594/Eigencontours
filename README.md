...
Our framework is based on [mmdetection](https://github.com/open-mmlab/mmdetection). Please check [mmdetection.md](https://github.com/dnjs3594/Eigencontours/blob/master/mmdetection.md) for installation instructions.
```
