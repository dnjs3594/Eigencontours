...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        # score
        self.contour_s = {}
        self.contour_s['eigen_t'] = 0
        self.contour_s['polar_t'] = 0
        self.contour_s['n'] = 0
        ...
        self.img_infos = self.load_annotations(ann_file, test_mode)
        ...
        # self.dist = 500 * math.sqrt(2) / 2
        # self.U = load_pickle("/data/CVPR2022/project/Preprocessing/E02/output_coco_train_v1_node_360_polarmask_flip/pickle/U").cpu()
        # self.U = load_pickle("/data/CVPR2022/project/Preprocessing/E02/output_coco_train_v2/pickle/U_iou").cpu()
